...
B. Introduction
	...
	4S -
		...
		IPC-P2104   IPC-P2104SI	IPC-P3104
		4243A
		IPC-A1004
	...
	8S -
		...
		5066UH      5066UHL	
		IPC-P2108   IPC-P2108SI	IPC-P3108	
	

	Cash Drawer -
		CDK1037A    CDK1037P	CDK1037H    CDK1037L	CDK1056A    CDK1056P 
		CDK1056H    CDK1056L    
...
C. Driver installation
	...
	C.1 Driver installation
		step 1. please double click "SUNIX WINCE 6.0 Driver Vx.x.x.x.msi"
		step 2. driver will install in C:\PLATFORM\SNXWINCE6.0\
		step 3. finish driver install wizard


	C.2 Add driver into Platform Design
		step 1.	open development IDE (Visual Studio 2005 for example)
		step 2. create a new project (Project types choice "Platform Builder for CE 6.0")
		step 3. select a BSP
		step 4. select a design templates
		step 5. in "Solution Explorer", choice "Subprojects" and click mouse right button
		step 6.	choice "Add Existing Subproject..." and open snxcard.pbpxml in 
			C:\PLATFORM\SNXWINCE6.0\
							
		step 7. use "Build Solution" to build OS image.							
			
			
	C.2 Change COM port number	
		step 1.	double click snxcard.reg file in "Parameter files" under "Subprojects"
		step 2. in "Source" mode, not "RegEdit" mode	
		step 3. change "Index" value to 1 ~ 9 to become COM1 ~ COM9,
...
D. Utility
	...
	D1. snxdump - dump port informations
		...
		step 1.	please download or copy snxdump.exe (C:\PLATFORM\SNXWINCE6.0\Utility\) 
			to target device
