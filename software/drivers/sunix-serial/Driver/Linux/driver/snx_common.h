...
*******************************************************/
#define SNX_DRIVER_VERSION 		"V2.0.8.0"
#define SNX_DRIVER_DATE			"2023/04/27"
...
extern int sunix_parport_proc_register(struct snx_parport *pp);
extern int sunix_parport_proc_unregister(struct snx_parport *pp);
extern int sunix_parport_device_proc_register(struct snx_pardevice *device);
extern int sunix_parport_device_proc_unregister(struct snx_pardevice *device);
